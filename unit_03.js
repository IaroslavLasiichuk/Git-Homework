...
const inputValue2 = 32;
const out= document.querySelector('.out-2');

 if (inputValue1 > inputValue2) {
    out.textContent = inputValue1;
   }
}
...
function f3(){
const inputValue1 = +document.querySelector('.i-31').value;
const inputValue2 = +document.querySelector('.i-32').value;
const out = document.querySelector('.out-3');

if (inputValue1 > inputValue2 ) {
   out.textContent = inputValue1;
}
else if (inputValue1 == 4) {
  out.textContent = inputValue2;
}
else if (inputValue1 == 9) {
  out.textContent = inputValue2;
}
else if (inputValue1 == 5) {
   out.textContent = inputValue2;
}
else  {
   out.textContent = inputValue2;
...
function f4(){
const inputValue1 = document.querySelector('.i-4').value;
const inputValue2 = 2021;
const result = document.querySelector('.out-4').textContent = inputValue2 - inputValue1;
...
function f6(){
   const number = document.querySelector('.i-6').value;
...
function f7(){
const inputValue1 =+ document.querySelector('.i-71').value;
const inputValue2 =+ document.querySelector('.i-72').value;
...
function f8(){
   const inputValue =+document.querySelector('.s-8').value;
...
function f10(){
  const option = document.querySelector('.s-100').value;
  const out10 = document.querySelector('.out-10');
  out10.textContent = option; 
}
...
function f11(){
  const option = document.querySelector('.s-110').value;
  const out = document.querySelector('.out-11');
  out.textContent = option; 
}
...
function f14(){
const inputValue =+ document.querySelector('.i-141').value;
const inputValue1 =+ document.querySelector('.i-142').value;
const option = document.querySelector('.s-143').value;
const out = document.querySelector('.out-14');
if (option == '+') {
   out.textContent = inputValue + inputValue1;
}
else if (option == '-') {
   out.textContent = inputValue - inputValue1;
}
...
function f15(){
   const select1 = document.querySelector('.s-151').value;
   const select2 = document.querySelector('.s-152').value;
   const select3 = document.querySelector('.s-153').value;
   const out = document.querySelector('.out-15');
   if (select3 == '&&') {
      out.textContent = select1 + '&&' +  select2;
   }
   else {
      out.textContent = select1 + '||' +  select2;
   }
